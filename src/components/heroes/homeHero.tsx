  ...
  return (
    <section className="relative overflow-hidden">
      <img
        ...
        alt="Background"
        className="absolute inset-0 h-full w-full sd:w-1/2 "
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-20 lg:py-32">
        <motion.div
          ...
          className="max-w-2xl"
        >
          <h1 className="md:text-3xl sm:text-2xl lg:text-4xl font-amped font-extrabold tracking-tight leading-tight text-gray-200">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <button className="rounded-2xl bg-yellow-100 text-white px-6 py-3 text-sm sm:text-base  font-semibold shadow-md hover:bg-yellow-175 transition">
              Explore Services
            </button>
            <button className="backdrop-blur-md rounded-2xl bg-black/50 px-6 py-3 text-sm sm:text-base font-semibold shadow border border-gray-800 hover:bg-black/70 hover:text-yellow-100/70  transition-colors duration-500">
              Contact Us
            </button>
          </div>
